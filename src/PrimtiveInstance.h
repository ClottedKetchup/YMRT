...
namespace YumeRT
{
	struct PrimitiveInstance
	{
		...
		__device__ __host__ inline PrimitiveInstance() : geometry_idx(EMPTY_UINT32), transform_idx(EMPTY_UINT32), transform_count(1), material_idx(EMPTY_UINT32), inner_volume_idx(-1), treat_as_boundary(0), unique_index(EMPTY_UINT32), padding(0) {}
