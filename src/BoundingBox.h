...
namespace YumeRT
{
	struct BBox3
	{
		...
		__device__ __host__ BBox3() : p_max(YumeRT_FLOAT_MIN), p_min(YumeRT_FLOAT_MAX) {}
		__device__ __host__ BBox3(const glm::vec3 &p) : p_max(p), p_min(p) {}
		__device__ __host__ BBox3(const glm::vec3 &p1, const glm::vec3 &p2) :
